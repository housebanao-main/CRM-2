...
import styles from './LeadSteps6.module.css';
...
const LeadSteps = ({ lead = {} }) => {
  ...
  const [meetingRecap, setMeetingRecap] = useState(""); // Ensure the state is defined properly
  ...
  const handleAddCallRecap = () => {
    setMeetingRecap(newTaskDescription); 
    setNewTaskDescription(""); 
  };
    ...
    <div className={styles.container}>
      ...
      <div className={styles.leftColumn}>
        ...
        <div className={styles.keyDetailsSection}>
          <h3 className={styles.detailsHeader}>Negotiation details</h3>
          <hr className={styles.separator} />
