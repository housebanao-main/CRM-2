...
import styles from './LeadSteps5.module.css';
...
const LeadSteps = ({ lead = {} }) => {
  ...
  const [callRecap, setCallRecap] = useState(""); // Call recap input value
  const [meetingRecap, setMeetingRecap] = useState(""); // Meeting recap display value
  ...
  const handleAddCallRecap = () => {
    setMeetingRecap(callRecap); // Set the meeting recap from the call recap input
    setCallRecap(''); // Clear the call recap input field
  };
    ...
    <div className={styles.container}>
      ...
      <div className={styles.leftColumn}>
              ...
              <div className={styles.tableRow}>
                <div className={styles.tableColumn}>
                  <input
                    ...
                    value={callRecap} // Bind the call recap input
                    onChange={(e) => setCallRecap(e.target.value)} // Update call recap on input change
        ...
        <div className={styles.keyDetailsSection}>
          <h3 className={styles.detailsHeader}>Follow up details</h3>
          <hr className={styles.separator} />
