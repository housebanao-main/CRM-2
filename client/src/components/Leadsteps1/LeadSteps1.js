...
const LeadSteps = ({ lead = {} }) => {
  ...
  // New state for storing call recap
  const [callRecap, setCallRecap] = useState('');
  const [meetingRecap, setMeetingRecap] = useState(''); // Store the final recap to show in the meeting details section
  ...
  // Function to handle adding call recap to meeting details
  const handleAddCallRecap = () => {
    setMeetingRecap(callRecap); // Set the call recap to the meeting details section
    setCallRecap(''); // Clear the input field after adding
  };
              ...
              <div className={styles.tableRow}>
                <div className={styles.tableColumn}>
                  <input
                    ...
                    value={callRecap} // Bind the input to the callRecap state
                    onChange={(e) => setCallRecap(e.target.value)} // Update state on input change
